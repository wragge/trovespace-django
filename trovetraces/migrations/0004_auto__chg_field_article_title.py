...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'trovetraces_article', 'title', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Article.title'
        db.alter_column(u'trovetraces_article', 'title', self.gf('django.db.models.fields.CharField')(max_length=250))
