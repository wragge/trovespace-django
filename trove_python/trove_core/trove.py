...
class TroveItem:
	...
	def convert_camelcase(self, name):
...
class TroveArticle(TroveItem):
	...
	def get_details(self):
		details = {}
		record = self.record
		details['title'] = self.get_title()
		details['date'] = record['date']
		details['page'] = record['page']
		details['newspaper_id'] = record['title']['id']
		details['newspaper_title'] = record['title']['value']
		return details
